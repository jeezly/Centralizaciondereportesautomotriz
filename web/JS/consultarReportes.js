document.addEventListener('DOMContentLoaded', async function() {
        ...
        reportes.forEach(reporte => {
            ...
            reporteCard.innerHTML = `
                <div class="reporte-icon">
                    <img src="../MEDIA/registroConsultar.png" alt="Consultar Reporte">
                </div>
            ...
            // Configurar evento para ver reporte
            reporteCard.addEventListener('click', () => {
                abrirVerReporte(reporte.id_cierre);
            });
    ...
    // Función para abrir la visualización de un reporte específico
    function abrirVerReporte(idReporte) {
        // Guardar el ID en sessionStorage y pasarlo por URL
        sessionStorage.setItem('reporteAVer', idReporte);
        window.location.href = `verReporteIndividual.html?id=${idReporte}`;
    }
});